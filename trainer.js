...
function getClientBuffer(index) {
  if (!GL.currentContext.clientBuffers[index]) {
    GL.currentContext.clientBuffers[index] = {};
  }
  return GL.currentContext.clientBuffers[index];
}
// --pre-jses are emitted after the Module integration code, so that they can
// refer to Module (if they choose; they can also define Module)
// include: /var/folders/fj/4jwfft7j6zz715mz0vpcjphh0000gn/T/tmp6xblm2ly.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'trainer.data';
      var REMOTE_PACKAGE_BASE = 'trainer.data';
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS(Module) {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_trainer.data');

      };
      Module['addRunDependency']('datafile_trainer.data');
    ...
    loadPackage({"files": [{"filename": "/Roboto-Black.ttf", "start": 0, "end": 164936}, {"filename": "/correct.wav", "start": 164936, "end": 257174, "audio": 1}], "remote_package_size": 257174});

  })();

// end include: /var/folders/fj/4jwfft7j6zz715mz0vpcjphh0000gn/T/tmp6xblm2ly.js
// include: /var/folders/fj/4jwfft7j6zz715mz0vpcjphh0000gn/T/tmpa6rnhh7b.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/fj/4jwfft7j6zz715mz0vpcjphh0000gn/T/tmpa6rnhh7b.js
// include: /var/folders/fj/4jwfft7j6zz715mz0vpcjphh0000gn/T/tmpjnuysz86.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/fj/4jwfft7j6zz715mz0vpcjphh0000gn/T/tmpjnuysz86.js
...
function findWasmBinary() {
    return locateFile('trainer.wasm');
}
